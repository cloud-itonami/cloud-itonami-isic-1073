# Business Model: Cocoa, Chocolate and Sugar Confectionery Manufacturing Coordination
...
## Classification
- Repository: `cloud-itonami-isic-1073` ([github.com/cloud-itonami/cloud-itonami-isic-1073](https://github.com/cloud-itonami/cloud-itonami-isic-1073))
- ISIC Rev.5: `1073` — Cocoa, Chocolate and Sugar Confectionery Manufacturing Coordination
- Domain: `:food/cocoa-chocolate-confectionery-manufacturing`
- Social impact: :food-security :food-safety :fair-labor
- Actor: `:chocops-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :food/cocoa-chocolate-confectionery-manufacturing — who wants
...
One managed tenant (:food/cocoa-chocolate-confectionery-manufacturing):
...
- Do not bypass the `:chocops-governor` for production decisions.
