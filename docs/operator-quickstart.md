# Operator Quickstart — Cocoa, Chocolate and Sugar Confectionery Manufacturing Coordination

Shortest path from clone to a verified local dry-run for **ISIC 1073** (`cloud-itonami-isic-1073`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1073.git
cd cloud-itonami-isic-1073
```
...
- Blueprint governor key: `chocops-governor`
- Likely source path: `chocops.governor.cljc`
